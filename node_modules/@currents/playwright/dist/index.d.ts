...
import { C as CurrentsConfig } from './config-Cm2w9G2E.js';
export { O as OrchestrationStatus } from './config-Cm2w9G2E.js';
...
type RULE_OPERATORS = (typeof OPS)[keyof typeof OPS];

type RuleAction = {
    op: "skip" | "quarantine";
};
type RuleCombinator = "AND" | "OR";
type RuleCondOperator = RULE_OPERATORS;
type RuleMatcherValue = string | string[] | null;
type RuleMatcherCond = {
    op: RuleCondOperator;
    value: RuleMatcherValue;
    type: "testId" | "project" | "title" | "titlePath" | "tag" | "annotation" | "file" | "git_branch" | "git_authorName" | "git_authorEmail" | "git_remoteOrigin" | "git_message";
};
type RuleMatcher = {
